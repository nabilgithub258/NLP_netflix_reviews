We are seeing the NLP in action with the data set provided from the kaggle regarding netflix and the user reviews, it has more then 100k reviews and due to the sheer high volume of those files,
